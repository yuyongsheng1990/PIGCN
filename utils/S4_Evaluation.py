...
def evaluate(extract_features, extract_labels, indices, epoch, num_isolated_nodes, save_path, former_save_path=None, # extract_features (952, 192); y, (4762); indices, (952,)
    ...
    if cluster_type == 'kmeans':
        ...
        n_tweets, n_classes, nmi, ami, ari, best_eps, best_cnum = run_dbscan(extract_features, extract_labels, indices, save_path, former_save_path)
    ...
    if cluster_type == 'dbscan':
        message += f'\n dbscan best_eps: {best_eps}. \n'
        message += f'\n dbscan best_min_Pts: {best_cnum}. \n'
